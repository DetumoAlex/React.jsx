...
const Navbar = () => {
  return (
    <nav className="w-full h-12 shadow flex items-center justify-around bg-gradient-to-r from-slate-500 via-gray-300 to-gray-200">
      <div>
        <p className="text-xl font-bold text-white uppercase">Detumo <span className="text-orange-600 ">.</span></p>
      </div>
      ...
      <div>
        ...
        <a href="" className="me-4 hover:underline hover:text-white">Testimonials</a>
        <a href="" className="me-4 hover:underline hover:text-white">Contact</a>
      </div>
